...
var ARMIES = {
	...
	"rapier":{"tags":["damage","shortrange","multitarget"],"damage":"2","damage_pow":"3"},
	"gun":{"tags":["damage","ammunition"],"damage":"1","damage_pow":"2", "amount":3},
	"shotgun":{"tags":["damage","multitarget","ammunition"],"damage":"2","damage_pow":"4", "amount":2},
	"crossbow":{"tags":["damage","largerange","ammunition"],"damage":"2","damage_pow":"4","amount":3},
