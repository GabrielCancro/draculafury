...
var texts = {
	...
	"army_kick_es":"Patada, alcance 1, causa 1 daño y empuja hacia atrás a un enemigo.",
	"army_rapier_es":"Estoque, alcance 2, causa 2 daños. Pega también a enemigos voladores que están adyacentes.",
	...
	"army_stake_es":"Estaca, largo alcance, causa 4 daños al primer enemigo, incluso si esta volando. (Solo una por cinturón in-progress)",
	"army_dynamite_es":"Dinamita, daño en area, causa 2 daños a todos los enemigos. (Solo una por cinturón, in-progress)",
